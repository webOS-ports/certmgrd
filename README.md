...
Summary
-------
Service to manage installed certificates on a device.

Description
-----------
certmgrd is the central daemon which interfaces with the pmcertificatemgr library to
provide certificate related services like listing, install or remove.
